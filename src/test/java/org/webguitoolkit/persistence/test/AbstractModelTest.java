...
public abstract class AbstractModelTest<T extends IPersistable> extends BaseHibernateTest {
	...
	protected T loadObjectFromSession(T source) throws Exception {
		return (T) ((HibernateUtility)getPersistenceUtility()).getSession().load(getObjectClass(), source.getId());
	}
